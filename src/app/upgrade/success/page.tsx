  ...
  return (
    <div style={{ background: '#EFE7D4', minHeight: '100vh' }}>
      ...
      <div className="max-w-xl mx-auto px-6 py-24 text-center">
        ...
        <h1 style={{ ...display, fontSize: 32, color: '#0F0F0E', marginBottom: 12 }}>You&apos;re All Set</h1>
        <p style={{ ...sans, fontWeight: 400, fontSize: 17, color: '#7C7A6E', marginBottom: 32, lineHeight: 1.6 }}>
          Your subscription is active. Your new listing allowance is live — get your dogs in front of buyers.
        </p>
